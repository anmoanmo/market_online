...
export const couponApi = {
  pageCoupon(page: number = 1, size: number = 10): Promise<JsonData<PageResult<CouponDO>>> {
    return request.get('/coupon-service/api/coupon/v1/admin_page', { params: { page, size } });
  },
  ...
  distributeBatch(couponId: number, registerDate: string, endTime: string): Promise<JsonData> {
    return request.post('/coupon-service/api/admin/coupon/v1/distribute/batch', { couponId, registerDate, endTime });
  },

  distributeSingle(userId: number, couponId: number, endTime: string): Promise<JsonData> {
    return request.post(`/coupon-service/api/admin/coupon/v1/distribute/single/${userId}`, null, {
      params: { couponId, endTime },
    });
  },
  ...
  addCoupon(data: {
    ...
    return request.post('/coupon-service/api/coupon/v1/admin_add', data);
  },

  updateCoupon(data: CouponDO): Promise<JsonData> {
    return request.put('/coupon-service/api/coupon/v1/admin_update', data);
  },
};